...
Given an integer I, student needs to determine the I-th least sum among all possible contiguous subarrays of 
the marks list.
...
class KthSmallestSubarraySum  
{
    ...
    public static int countSubarrays(int[] nums, int mid) 
    {
        int count = 0; 
        int sum = 0; 
    ...
    public static void main(String[] args) 
    {
        ...
        for(int i=0;i<n;i++) 
            array[i]=sc.nextInt(); 
        System.out.println(kthSmallestSubarraySum(array, k)); 
        sc.close();
    } 
} 
